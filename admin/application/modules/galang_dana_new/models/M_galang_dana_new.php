...
class M_galang_dana_new extends CI_Model {
	...
	function tambah()
	{
		...
		if($_FILES['gambar']['name'])
        {
            if ($this->upload->do_upload('gambar'))
            {
				...
				$this->db->insert('galang_dana_new', $data);
	...
	function edit()
	{
		...
		if($_FILES['gambar']['name'])
        {
            if ($this->upload->do_upload('gambar'))
            {
				...
				$this->db->where('id_galangdana',$id)->update('galang_dana_new', $data);
	...
	{
		$id = $this->input->post('id');
		$this->db->where('id_galangdana', $id)->delete('galang_dana_new');

                                    ...
                                    <div class="d-inline-block dropdown">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="galang_dana_new/tambahview">
                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-warning">
                                                ...
                                                <a href="<?php echo base_url('galang_dana_new/editview/'. encrypt_url($res->id_galangdana)); ?>" type="button" class="btn btn-primary">

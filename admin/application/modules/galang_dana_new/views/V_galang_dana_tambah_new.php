...
<div class="app-main__inner">
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                 ...
                                 <a href="<?php echo base_url('galang_dana_new'); ?>" class="mb-2 mr-2 btn btn-shadow btn-success">Kembali</a>
                                </div>    </div>
                        </div>   
 ...
 <form action="<?php echo base_url('galang_dana_new/tambah') ?>" method="POST" enctype="multipart/form-data">

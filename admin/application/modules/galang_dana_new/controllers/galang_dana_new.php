...
class Galang_dana_new extends MX_Controller {
  ...
  function __construct() {
    ...
    $this->load->model('M_galang_dana_new');
  ...
  function index() {
    $data = array(
			...
			'namafileview' 	=> "V_galang_dana_new",
			'tampil'		=> $this->M_galang_dana_new->tampil(),
		);
  ...
  function add_ajax_des($id_kec){
	...
	function tambah()
	{
		$this->M_galang_dana_new->tambah();
		redirect('galang_dana_new');
	}
	...
	function editview($id)
	{
		...
		$data = array(
			'namamodule' 	=> "galang_dana_new",
			'namafileview' 	=> "V_galang_dana_edit_new",
			'tampil'		=> $this->M_galang_dana_new->tampiledit($id),
		);
		echo Modules::run('template/tampilCore', $data);
	}

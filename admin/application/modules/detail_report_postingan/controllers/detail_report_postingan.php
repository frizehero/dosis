...
class Detail_report_postingan extends MX_Controller {

	function __construct()
	{
		parent::__construct();
		// model
		 $this->load->model('M_detail_report_postingan');
	...
	function index()
	{
		...
		if ( empty( $this->session->userdata('session_id') ) )
		{
			...
			$data = array(
			'namamodule' 	=> "detail_report_postingan",
			'namafileview' 	=> "V_detail_report_postingan",
		);

                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="col-md-6">    
                                                                                <div class="position-relative form-group">
                                                                                        ...
                                                                                        <select name="kategori_penerima" class="multiselect-dropdown form-control">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <div class="card mb-3 bg-primary widget-content">
                                                                                        <div class="widget-content-wrapper">
                                                                                            <div class="widget-content-left">
                                                                                                <input name="foto2" id="exampleFile" type="file" class="form-control-file">
                                                                                                <small class="form-text text-light">Gunakan File format PNG/JPG Max 10 MB</small>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <div class="card mb-3 bg-primary widget-content">
                                                                                        <div class="widget-content-wrapper">
                                                                                            <div class="widget-content-left">
                                                                                                <input name="foto3" id="exampleFile" type="file" class="form-control-file">
                                                                                                <small class="form-text text-light">Gunakan File format PNG/JPG Max 10 MB</small>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>

                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-warning">
                                                ...
                                                <a href="<?php echo base_url('galang_dana2/editview/'. encrypt_url($res->id_galang_dana2)); ?>" type="button" class="btn btn-primary">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                             <!--Modal body-->
                                ...
                                <input name="id"  type="hidden" value="<?php echo $res->id_galang_dana2 ?>" class="form-control">
                          </div>

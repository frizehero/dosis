                                                        ...
                                                        <div class="form-row">                                                          
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="nama_pembuka" id="exampleAddress" placeholder="" value="<?php echo $tampil['nama_pembuka']?>" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group">
                                                        ...
                                                        <div class="form-row">  
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="telepon_pembuka"exampleAddress telepon_pembuka="exampleAddress" placeholder="" value="<?php echo $tampil['telepon_pembuka']?>" type="text" class="form-control">
                                                                </div>                                                                    
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group">
                                                                    <label for="exampleAddress">No Whatsapp</label>
                                                                     <input name="whatsapp_pembuka" value="<?php echo $tampil['whatsapp_pembuka']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-row">
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="instagram_pembuka" value="<?php echo $tampil['instagram_pembuka']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                </div>
                                                            </div>  
                                                            <div class="col-md-6">
                                                                <div class="position-relative form-group">
                                                                    <label for="exampleAddress">Facebook</label>
                                                                    <input name="facebook_pembuka" value="<?php echo $tampil['facebook_pembuka']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="card mb-3 bg-primary widget-content">
                                                                        <div class="widget-content-wrapper">
                                                                            <div class="widget-content-left">
                                                                                <input name="foto" value="<?php echo $tampil['identitas_pembuka']?>" id="exampleFile" type="file" class="form-control-file">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    <label for="exampleEmail11" class="">Provinsi</label>
                                                                        <select data-placeholder="Provinsi" name="provinsi_pembuka" class="multiselect-dropdown form-control">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    <label for="exampleEmail11" class="">Kota/Kabupaten</label>
                                                                        <select name="kota_pembuka" class="multiselect-dropdown form-control">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    <label for="exampleEmail11" class="">Kelurahan/Desa</label>
                                                                        <select name="kelurahan_pembuka" class="multiselect-dropdown form-control">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="position-relative form-group">
                                                                    ...
                                                                    <input name="kode_pos_pembuka" value="<?php echo $tampil['kode_pos_pembuka']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="form-row">
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input name="nama_penerima" value="<?php echo $tampil['nama_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    <label for="exampleAddress">Alamat Penerima</label>
                                                                                    <input name="alamat_penerima" value="<?php echo $tampil['alamat_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input name="sekolah_penerima" value="<?php echo $tampil['sekolah_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input name="telepon_penerima" value="<?php echo $tampil['telepon_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>  
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    <label for="exampleAddress">Whatsapp</label>
                                                                                    <input name="whatsapp_penerima"value="<?php echo $tampil['whatsapp_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    <label for="exampleAddress">Instagram</label>
                                                                                    <input name="instagram" value="<?php echo $tampil['instagram_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>  
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    <label for="exampleAddress">Facebook</label>
                                                                                    <input name="facebook" value="<?php echo $tampil['facebook_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <div class="card mb-3 bg-primary widget-content">
                                                                                        <div class="widget-content-wrapper">
                                                                                            <div class="widget-content-left">
                                                                                                <input name="foto" value="<?php echo $tampil['identitas_penerima']?>" type="file" class="form-control-file">
                                                                                                <small class="form-text text-light">Gunakan File format PNG/JPG Max 10 MB</small>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="col-md-12">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input name="judul_donasi_penerima" value="<?php echo $tampil['judul_donasi_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-row">
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="col-md-4">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input type="date" value="<?php echo $tampil['tanggal_mulai']?>" class="form-control" name="tanggal_mulai">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="position-relative form-group">
                                                                                    <label for="exampleAddress">Tanggal Berakhir</label>
                                                                                    <input type="date" value="<?php echo $tampil['tanggal_akhir']?>" class="form-control" name="tanggal_akhir">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="position-relative form-group">
                                                                                    <label for="exampleAddress">Target Donasi</label>
                                                                                    <input name="jml_donasi" value="<?php echo $tampil['target_donasi_penerima']?>" id="exampleAddress" placeholder="RP20.000.000,00" type="text" class="form-control">
                                                                                </div>
                                                                            </div> 
                                                                        </div>
                                                                        <div class="form-row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="position-relative form-group">
                                                                                    ...
                                                                                    <input name="kode_pos_" value="<?php echo $tampil['kode_pos_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-4">
                                                                                <div class="position-relative form-group">
                                                                                    <label for="exampleAddress">No Rekening</label>
                                                                                    <input name="no_rekening_penerima" value="<?php echo $tampil['no_rekening_penerima']?>" id="exampleAddress" placeholder="" type="text" class="form-control">
                                                                                </div>
                                                                            </div>

...
class M_galang_dana2 extends CI_Model {
		...
		if($_FILES['foto']['name'])
        {
            if ($this->upload->do_upload('foto'))
            {
				...
				$data = array(
					...
					'facebook'					=> $facebook,
					'twitter'					=> $twitter,
					'identitas_pembuka' 		=> $identitas_pembuka,
					'provinsi'					=> $provinsi,
					'kota'						=> $kota,
					'kelurahan'					=> $kelurahan,
					'kecamatan'					=> $kecamatan,
					...
					'dokumentasi_peristiwa1' 	=> $gbr['file_name'],
				...
				$data = array(
					...
					'deskripsi_peristiwa'		=> $deskripsi_peristiwa,
					'tujuan_galang_dana'		=> $tujuan_galang_dana,
					'dokumentasi_peristiwa1' 	=> 'kosong1.jpeg',
					'dokumentasi_peristiwa2' 	=> $dokumentasi_peristiwa2,
					'dokumentasi_peristiwa3' 	=> $dokumentasi_peristiwa3,
					'tgl_awal'					=> $tgl_awal,
					'tgl_akhir'					=> $tgl_akhir,
	...
	function edit()
	{
		...
		$deskripsi_peristiwa		= $this->input->post('deskripsi_peristiwa');
		$tujuan_galang_dana			= $this->input->post('tujuan_galang_dana');
		$dokumentasi_peristiwa1		= $this->input->post('dokumentasi_peristiwa1');
		...
		if($_FILES['foto']['name'])
        {
            if ($this->upload->do_upload('foto'))
            {
				...
				$data = array(
					...
					'deskripsi_peristiwa2'		=> $deskripsi_peristiwa2,
					'deskripsi_peristiwa3'		=> $deskripsi_peristiwa3,
					'tgl_awal'					=> $tgl_awal,
					'tgl_akhir'					=> $tgl_akhir,
					'jml_donasi'				=> $jml_donasi,
					'provinsi_penerima'			=> $provinsi_penerima,

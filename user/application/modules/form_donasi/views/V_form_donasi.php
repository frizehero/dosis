                                    ...
                                    <div class="d-inline-block dropdown">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="form_donasi/tambahview">
                                                        <i class="nav-link-icon lnr-inbox"></i>
                                                        <span> Tambah Data</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="<?php echo base_url('form_donasi/export'); ?>">
      ...
      <table id="myTable" class="display nowrap table table-bordered table-condensed table-hover">
        <thead>
                                    ...
                                    <tr>
                                        ...
                                        <a href="<?php echo base_url('form_donasi/editview/'. encrypt_url($res->id_inv_peralatan)); ?>" type="button" class="btn btn-primary">
                    ...
                    <div class="modal fade" id="hapus<?php echo $no ?>"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo base_url('form_donasi/hapus') ?>" method="POST" enctype="multipart/form-data">

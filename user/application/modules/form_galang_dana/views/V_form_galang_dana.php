                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <a href="<?php echo base_url('inventory_peralatan/tambahview'); ?>" class="mb-2 mr-2 btn btn-shadow btn-warning">Halaman Input</a>
                                  ...
                                  <a href="<?php echo base_url('form_galang_dana/tambahview'); ?>" class="mb-2 mr-2 btn btn-shadow btn-success">Tambah Data</a>
                            ...
                            <div class="card-body">
                                ...
                                <table style="width: 100%;" id="example"  class="table table-hover table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('form_galang_dana/editview/'. encrypt_url($rowP->id_inv_room)); ?>" class="btn btn-primary">
                    ...
                    <div class="modal fade" id="hapus<?php echo $no ?>"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo base_url('form_galang_dana/hapus') ?>" method="POST" enctype="multipart/form-data">

                        ...
                        <div class="app-page-title">
                            <div class="page-title-wrapper">
                                ...
                                <div class="page-title-actions">
                                 ...
                                 <a href="<?php echo base_url('form_galang_dana'); ?>" class="mb-2 mr-2 btn btn-shadow btn-success">Kembali</a>
                                </div>    </div>
                        </div>   
                        <div class="col-md-6">
                        <div class="main-card mb-3 card">

                            <form action="<?php echo base_url('form_galang_dana/tambah') ?>" method="POST" enctype="multipart/form-data">
                                <div class="card-body">

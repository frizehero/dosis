...
class kategori_tidak_mampu extends MX_Controller {

	function __construct()
	{
		parent::__construct();
		// model
		 $this->load->model('m_kategori_tidak_mampu');
	...
	function index()
	{
		...
		if ( empty( $this->session->userdata('session_id') ) )
		{
			...
			$data = array(
			'namamodule' 	=> "kategori_tidak_mampu",
			'namafileview' 	=> "V_kategori_tidak_mampu",
		);

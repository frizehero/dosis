...
class Kategori_pembangunan extends MX_Controller {

	function __construct()
	{
		parent::__construct();
		// model
		 $this->load->model('m_kategori_pembangunan');
	...
	function index()
	{
		...
		if ( empty( $this->session->userdata('session_id') ) )
		{
			...
			$data = array(
			'namamodule' 	=> "kategori_pembangunan",
			'namafileview' 	=> "V_kategori_pembangunan",
		);

                                            ...
                                            <div class="list-single-main-wrapper fl-wrap" id="sec2">
                                                    ...
                                                    <div class="list-single-main-item fl-wrap">
                                                        <div class="list-single-main-item-title fl-wrap">
                                                            <h3>BANTU KAMI UNTUK KEMBALI SEKOLAH LAGI</h3><br>
                                                            <hr>
                                                            </br>
                                                            <h3>DESKRIPSI</h3>
                                                        </div>
                                                        <p>Banjir merupakan sebuah bencana alam yang di sebabkan oleh beberapa faktor yaitu, faktor alam dan faktor manusia. Faktor alam yang dapat menyebabkan banjir adalah, erosi (pengikisan tanah), serta tanah longsor, hujan lebat dan masih banyak lagi faktor alam yang mempengaruhinya. Naumun faktor manusilah yang menjadi faktor utama banjir, seperti penebangan pohon secara liar, pembuangan sampah di sungai hingga menyumbat alirannya sehingga mengakibatkan banjir.</p></br>
                                                            <img src="images/all/28.jpg" alt="" width="650px">
                                                            <br>
                                                            <br>
                                                        <p>Contohnya banjir di Jakarta merupakan masalah utama di kota tersebut. Segala cara telah di lakukan pemerintah untuk menanggulangi banjir namun tetap saja masalah tersebut belum kunjung terselesaikan, sebetulnya banjir di Jakarta bukan di sebabkan oleh sungai-sungai besar yang ada di sekitarnya, penyebabnya adalah sistem drainase yang salah, pembangunan gedung-gedung bertingkat tanpa memikirkan dampak kedepannya. Ada banyak sekali dampak yang di sebabkan oleh banjir, salah satunya adalah rusaknya rumah-rumah, air yang di bawa merupakan sumber penyakit karena terkontaminasi sampah yang di buang sembarangan di sekitar bantaran kali. Kita sebagai anak generasi muda harus mencintai lingkungan alam sekitar kita karena sikap tersebut mencerminkan kecintaan pada bangsa.</p>
                                                            <hr>
                                                            </br>
                                                        <div class="list-single-main-item-title fl-wrap">
                                                            </br>
                                                            ...
                                                            <p>Adanya tujuan program disambut antusias oleh warga yang ingin membaca Al-Qur'an atau Iqra. 700 paket Qur'an dan Iqro siap didistribusikan untuk mereka.
                                                                "Pemberian Qur'an ini sangat membantu kami untuk ibadah. Di Kecamatan Sukajaya ini juga ada beberapa pesantren yang sangat membutuhkan mushaf Qur'an maupun Iqro." Ungkap Ustadz Bubun yang biasa mengajar ngaji anak anak.</p>
                                                            </br>
                                                        ...
                                                        <div class="post-author"><a href="profil-penggalang dana.html"><img src="images/avatar/4.jpg" alt=""><span>By , Abdul Hasan</span></a></div>
                                                        <div class="post-opt">
                                                            <ul>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="list-widget-social" style="margin-right: 5px;">
                                                                    <ul>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="list-widget-social">
                                                                    <ul>
                                                                        <li><a class="show-reg-form modal-open" style="width: 100px; margin-top: -90px; margin-left: 665px; background-color: red;" class="add-list"><i class="fa fa-warning"></i>Report</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>    
                                                        </div>
                                                            ...
                                                            <div class="list-author-widget-text">
                                                                ...
                                                                <hr>
                                                                    ...
                                                                    <div class="geodir-category-options fl-wrap">
                                                                        <div class="geodir-category-location" style="margin-right: 190px; margin-top: 30px; color: #0984e3;"><i><b>Target Rp 15,000,000</b></i></div>
                                                                        <p style="margin-left: 263px; margin-top: -15px; color: black;"><b>229 Donasi</b></p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>

...
class Kategori_tanah_longsor extends MX_Controller {

	function __construct()
	{
		parent::__construct();
		// model
		 $this->load->model('m_kategori_tanah_longsor');
	...
	function index()
	{
		...
		if ( empty( $this->session->userdata('session_id') ) )
		{
			...
			$data = array(
			'namamodule' 	=> "kategori_tanah_longsor",
			'namafileview' 	=> "V_kategori_tanah_longsor",
		);

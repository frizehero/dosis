<div class="content">
                    ...
                    <section class="scroll-con-sec hero-section" data-scrollax-parent="true" id="sec1">
                        <div class="slideshow-container" data-scrollax="properties: { translateY: '200px' }" >
                            ...
                            <!-- slideshow-item -->
                            <div class="slideshow-item">
                                <div class="bg"  data-bg="images/bg/b.jpg"></div>
                            </div>
                            <!--  slideshow-item end  -->
                            <!-- slideshow-item -->
                            <div class="slideshow-item">
                                <div class="bg"  data-bg="images/bg/c.jpg"></div>
                            </div>
                            <!--  slideshow-item end  -->
                            <!-- slideshow-item -->
                            <div class="slideshow-item">
                                <div class="bg"  data-bg="images/bg/d.jpg"></div>
                            </div>
                            <!--  slideshow-item end  -->
                            <!-- slideshow-item -->
                            <div class="slideshow-item">
                                <div class="bg"  data-bg="images/bg/e.jpg"></div>
                            </div>
                            <!--  slideshow-item end  -->
                            <!-- slideshow-item -->
                            <div class="slideshow-item">
                                <div class="bg"  data-bg="images/bg/f.jpg"></div>
                            </div>
                            <!--  slideshow-item end  -->
                            <!-- slideshow-item -->
                            <div class="slideshow-item">
                                <div class="bg"  data-bg="images/bg/g.jpg"></div>
                            </div>
                            <!--  slideshow-item end  -->
                        </div>
                    ...
                    <!-- section end -->
                    <!--section -->
                    <section style="background-color: rgb(231, 231, 231);">
                        <div class="shapes-bg-big"></div>
                        <div class="container">
                            <div class="section-title">
                                <h2>PILIHAN DONASI </h2>
                                ...
                                <div class="section-title">
                                    ...
                                    <div class="main-search-input-wrap">
                                        <div class="main-search-input fl-wrap">
                                            ...
                                            <div class="main-search-input-item">
                                                <select data-placeholder="Sekolah" multiple class="chosen-select" >
                                                    <option>SMK</option>
                                                    <option>SMA</option>
                                                    <option>SMP</option>
                                                    <option>SD</option>
                                            ...
                                            <div class="main-search-input-item">
                                                <select data-placeholder="Filter" multiple class="chosen-select" >
                            ...
                            <div class="list-main-wrap fl-wrap card-listing" style="padding: 0px 30px 50px 30px;">
                                ...
                                <div class="listing-item" style="width: 320px;">
                                    <article class="geodir-category-listing fl-wrap">
                                        ...
                                        <div class="geodir-category-content fl-wrap" style="height : 280px;">
                                            <a class="listing-geodir-category" href="#">Selesai</a>
                                            <div class="listing-avatar"><a href="author-single.html"><img src="images/avatar/5.jpg" alt=""></a>
                                                <span class="avatar-tooltip">Posting oleh  <strong>Dhinda</strong></span>
                                            </div>
                                            <h3><a href="user-detail-donasi.html">Bantu Doni kembali sekolah lagi</a></h3>
                                            <p><b>5</b> <i> hari tersisa</i>  </p>
                                            <div class="distance-title"> 
                                                <b>Rp 8.000,000</b> Terkumpul   <span style="padding-left: 60px;">100</span> %
                                            </div>
                                                <div class="distance-radius-wrap fl-wrap">
                                                    <input class="distance-radius rangeslider--horizontal" type="range" min="1" max="100" step="1" value="1" data-title="Radius around selected destination" style="position: absolute; width: 1px; height: 1px; overflow: hidden; opacity: 0;">
                                                    <div class="rangeslider rangeslider--horizontal" id="js-rangeslider-0">
                                ...
                                <div class="listing-item"></div>
                                <div class="listing-item"></div>
                                <a href="#" class="btn  big-btn circle-btn dec-btn  color-bg flat-btn" style="padding: 10px 550px 10px 550px;">TAMPILKAN LEBIH BANYAK</a>
                            </div>
                    ...
                    <!--section -->
                    <section class="color-bg" style="background-image: url(images/bg/zzz.jpg);">
                        <div class="container">
                            <div class=" single-facts fl-wrap">
                                    ...
                                    <div class="inline-facts">
                                        <div class="milestone-counter">
                                            <div class="stats animaper">
                                                <div class="num" data-content="0" data-num="254">892,345</div>
                                            </div>
                                        </div>
                                        <h6>Aksi Donasi</h6>
                                    </div>
                                ...
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        <div class="milestone-counter">
                                            <div class="stats animaper">
                                                <div class="num" data-content="0" data-num="12168">45,876</div>
                                            </div>
                                        </div>
                                        <h6>Transaksi</h6>
                                    </div>
                                ...
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        <div class="milestone-counter">
                                            <div class="stats animaper">
                                                <div class="num" data-content="0" data-num="172">172,865,321</div>
                                            </div>
                                        </div>
                                ...
                                <div class="inline-facts-wrap">
                                    <div class="inline-facts">
                                        <div class="milestone-counter">
                                            <div class="stats animaper">
                                                <div class="num" data-content="0" data-num="74">172,865,321</div>
                                            </div>
                                        </div>
                                        <h6>Pengunjung</h6>
                                    </div>
                    ...
                    <section>
                        <div class="container">
                            <div class="section-title">
                                ...
                                <div class="section-subtitle">DONASI SISWA </div>
                                <span class="section-separator"></span>
                            </div>
                        </div>

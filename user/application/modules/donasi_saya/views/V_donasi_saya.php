                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="profile-edit-container">
                                            ...
                                            <!-- statistic-item-wrap--> 
                                                <div class="statistic-item-wrap" style="width:300px; height:120px; padding-right: 15px;"> 
                                            ...
                                            <div class="dashboard-list">
                                                ...
                                                <div class="dashboard-message">
                                                    <div class="dashboard-message-text">
                                                        ...
                                                        <p><i class="fa fa-gears" style="margin-left:235px;"></i> Waktu Transfer : 14.00 WIB</p>
                                                        <div class="distance-title" style="margin-bottom:-25px; margin-left:235px;"> 
